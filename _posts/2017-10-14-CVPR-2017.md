...
<div align="center" >
<img src="/images/cvpr2017/p2s-3.PNG" width="60%" align="center" />
</div>
...
此外在网络结构上，结合了Global Sub-Network、Local Sub-Network和Fusion Sub-Network用于全局+局部的特征表示和学习，并最后通过全链接层进行融合，最后concat的特征表示通过P2S的loss layer比较相似性进而对网络进行训练：
